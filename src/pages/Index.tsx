        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Reserve o seu espaço ideal em apenas alguns passos simples
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="relative mb-6">
                ...
                <div className="w-20 h-20 bg-gradient-primary rounded-full flex items-center justify-center mx-auto group-hover:shadow-soft transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Encontre espaços de trabalho próximos com filtros avançados por localização, preço e comodidades.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Veja horários disponíveis em tempo real e escolha o período que melhor se adequa às suas necessidades.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Pague de forma segura com múltiplas opções: cartão, PayPal, M-Pesa, mKesh ou e-Mola.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Desfrute do seu espaço de trabalho ideal com confirmação instantânea e suporte dedicado.
              </p>
            </div>
          </div>
        </div>
